  ...
  const tools: ToolCard[] = [
    {
      ...
      Icon: IconAssistant,
      label: 'The Armorer',
      sub: 'AI assistant to help you plan, train, and improve',
      available: true,
    ...
    },
    {
      ...
      sub: 'Build and track custom loads, optimize charges and performance',
      available: true,
    ...
    },
    {
      ...
      Icon: IconWishlist,
      label: 'Wishlist',
      sub: 'Track the firearms and gear you want to add next',
      available: true,
    ...
    },
    {
      ...
      Icon: IconFieldGuide,
      label: 'Field Guide',
      sub: 'Cartridges, platforms, ballistics, and firearms reference',
      available: true,
    ...
    },
    {
      ...
      Icon: IconSupport,
      label: 'Support',
      sub: 'Questions, feedback, and bug reports',
